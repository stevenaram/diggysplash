export const CARAVAN_DURATION=28;
export const caravanEase=(t:number)=>{t=Math.max(0,Math.min(1,t));return t*t*(3-2*t);};
export function caravanPose(t:number){return {drink:caravanEase(t/2.5),hitch:caravanEase((t-2.5)/4),roll:caravanEase((t-7.5)/2),ambush:caravanEase((t-10)/2),defeat:caravanEase((t-12)/1.2),pile:caravanEase((t-13.5)/2),fire:caravanEase((t-15.5)/.6),escape:caravanEase((t-17)/10)};}
